...
<body>
    ...
    <form id="form1" runat="server" class="style9">
        ...
        <div style="width:49%; float:left; border:dotted;">
            ...
            <div style="width:50%; float:left;"><asp:Button ID="Button1" Class="buttonClass" runat="server" onclick="Button1_Click" Text="Back" /></div><div style="width:50%; float:left;"><asp:Button ID="Button2" runat="server" onclick="Button2_Click" Text="SAVE" Class="buttonClass" /></div><br /><br />
        </div>
        <div style="width:49.5%; float:right; border:dotted;">
            ...
            <div style="width:50%; float:left;"><asp:Button ID="Button7" runat="server" Text="Update Stock" OnClick="Button7_Click" Class="buttonClass" Width="125px"/></div><div style="width:50%; float:left;"><asp:Button ID="Button14" runat="server" Text="Clear" OnClick="Button14_Click" Class="buttonClass"/></div><br /><br />
