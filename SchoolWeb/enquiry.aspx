...
<br />
        <div style="width:100%;">
            <div style="width:25%; float:left; background-color:aquamarine; border-style:solid;"><br />
                ...
                <div style="width:25%; float:left; margin-left:50px;"><asp:Button ID="Button1" runat="server" Text="Save" OnClick="Button1_Click" TabIndex="7" Class="buttonClass"/></div><div style="width:25%; float:left;"><asp:Button ID="Button2" runat="server" Text="Clear" OnClick="Button2_Click" TabIndex="8" Class="buttonClass"/></div>
            ...
            <div style="width:25%; float:left; background-color:burlywood; border-style:solid;"> <br />
                <div style="width:25%; float:left;">Enquiry ID</div><div><asp:TextBox ID="TextBox4" runat="server" Width="85px"></asp:TextBox><asp:Button ID="Button4" runat="server" Text="Get" Class="buttonClass" Height="35px" OnClick="Button4_Click" /></div> <br />
                ...
                <div style="float:left;"><asp:Button ID="Button5" runat="server" Text="Add to Students" OnClick="Button5_Click" Class="buttonClass" Width="150px"/></div><div style="float:right; margin-right:100px;"><asp:Button ID="Button6" runat="server" Text="Clear" OnClick="Button6_Click" Class="buttonClass"/></div> <br /> <br /> 
            </div>
