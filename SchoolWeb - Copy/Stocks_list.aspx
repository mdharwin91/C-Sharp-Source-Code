...
<body style="height: 56px">
    <form id="form1" runat="server">
        <div style="height: 55px">
            ...
            <h3 style="margin: 0px; padding: 0px; list-style: none; text-decoration: none; color: rgb(0, 0, 128); font-family: &quot;Cooper Black&quot;; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255);">NURSERY AND PRIMARY SCHOOL</h3>
        </div><br /><br />
        <div>
