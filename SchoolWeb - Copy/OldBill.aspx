...
<body bgcolor="#000000">
    ...
    <div>
            <div class="Sec-header">
                ...
                <div class="Sec-titlebar">
                    ...
                    <div style="width:10%; float:right; font-size:x-large;"><a href="<%= ResolveUrl("todaybills.aspx") + "?val=" + Label2.Text %>"><li style="color:red;">Day Bill</li></a></div>
                    <div style="width:10%; float:right; font-size:x-large;"><a href="<%= ResolveUrl("billedbetween.aspx") + "?val=" + Label2.Text %>"><li style="color:red;">Between</li></a></div>
                    <div style="width:10%; float:right; font-size:x-large;"><a href="<%= ResolveUrl("oldbill.aspx") + "?val=" +  Label2.Text%>"><li style="color:aqua;">Old Bill</li></a></div>
    ...
    <p>
        ...
        <span lang="en-us" class="style20">&nbsp;<span class="style22">Billed Details for Specific Student</span></span><p>
        <span lang="en-us">&nbsp;<asp:Label ID="Label1" runat="server" 
            Font-Size="Large" Text="Admission Number"></asp:Label></span>
    ...
    <br />
                ...
                <asp:Button ID="Button19" runat="server" OnClick="Button19_Click" Text="Get" Width="31px" />
    <span lang="en-us">&nbsp;&nbsp;&nbsp;<asp:Button ID="Button17" runat="server" OnClick="Button17_Click" Text="Last Month" />
        &nbsp;&nbsp;
        <asp:Button ID="Button18" runat="server" OnClick="Button18_Click" Text="Month to Date" />
            ...
            <div style="width:70%; float:right">
                <center><b>Details</b></center><br />
                <center>
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" 
        DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" 
        Height="56px" HorizontalAlign="Center" PageSize="2" Width="984px" DataKeyNames="ad_num">
